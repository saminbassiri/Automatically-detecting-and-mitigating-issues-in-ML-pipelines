...
raw_data_file = os.path.join(str(project_root), "Examples/datasets", "compas_scores", "compas-scores-two-years.csv")
#####################
...
report = classification_report(test_labels, y_pred, output_dict=True, zero_division=0)  # Output as a dictionary
accuracy = accuracy_score(test_labels, y_pred)  # Compute accuracy separately

# Add accuracy to the report
report["accuracy"] = accuracy

# Save the metrics to a JSON file
with open("Examples/Predicted/Data_Slicing1.json", "w") as json_file:
